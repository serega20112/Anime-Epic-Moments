...
def test_search_by_title_uses_cache_for_repeated_queries(include_adult):
    ...
    first = client.search_by_title("FMA", limit=5, include_adult=include_adult)
    second = client.search_by_title("FMA", limit=5, include_adult=include_adult)
...
def test_get_by_id_caches_fallback_result(anime_factory):
    ...
    first = client.get_by_id(918)
    second = client.get_by_id(918)
...
def test_search_by_description_uses_cache_with_filter_signature(filters, expected_call_count):
    ...
    first = client.search_by_description("ninja", limit=8, **filters)
    second = client.search_by_description("ninja", limit=8, **filters)
