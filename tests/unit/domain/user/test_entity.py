...
class TestUserValidation:
    ...
    def test_rejects_invalid_username_length(self, username):
...
class TestUserBehaviour:
    ...
    @pytest.mark.unit
    def test_updates_avatar_and_username(self):
    ...
    @pytest.mark.unit
    def test_check_password_is_not_supported_in_domain(self):
