...
class TestAnimeEntity:
    ...
    async def test_anime_add_genre_avoids_duplicates(
    ...
    async def test_anime_remove_genre_is_safe(self, anime_factory, initial_genres, genre, expected):
    ...
    @pytest.mark.unit
    async def test_anime_constructor_uses_empty_genre_list_by_default(self):
