...
@pytest.mark.unit
async def test_highlight_dashboard_cache_returns_saved_public_dashboard():
...
@pytest.mark.unit
async def test_highlight_dashboard_cache_invalidates_public_dashboards():
...
@pytest.mark.unit
async def test_highlight_dashboard_cache_separates_popular_and_recent_dashboards():
