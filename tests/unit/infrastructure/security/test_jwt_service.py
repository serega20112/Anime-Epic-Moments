...
from backend.infrastructure.security import jwt_service as jwt_service_module
from backend.infrastructure.security.jwt_service import ALGORITHM, JWTService
