...
from backend.presentation.api.v1 import recommendation_route as recommendation_route_module
from backend.presentation.api.v1.recommendation_route import recommendation_bp
