...
from backend.presentation.api.v1 import collection_route as collection_route_module
from backend.presentation.api.v1.collection_route import collection_bp
        ...
        SimpleNamespace(
            get_shared_collection_use_case=lambda: SimpleNamespace(
                execute=lambda collection_id: SimpleNamespace(
                    ...
                    items=[SimpleNamespace(title="Gintama", anime_id=7, description="", genres=[],
