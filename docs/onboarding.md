...
Этот документ — самый короткий практический путь для нового разработчика: как поднять приложение, понять структуру репозитория и сделать первое безопасное изменение.
