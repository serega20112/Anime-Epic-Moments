...
Эта директория — навигационный слой проекта. Ее задача — сделать репозиторий читаемым как продукт: что делает система, как она устроена, почему приняты конкретные решения и где каждая зона ответственности живет в коде.

## Как читать документацию

Начинать нужно с общей формы системы, затем перейти к домену, потом к интерфейсам и только после этого к эксплуатационным аспектам:
