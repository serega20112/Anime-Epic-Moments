...
Система организована как многослойное Flask-приложение с DDD-подобными границами. Delivery-слой принимает HTTP-запросы, use case оркестрируют действия, domain-объекты описывают язык продукта, а infrastructure-слой владеет побочными эффектами: PostgreSQL, Redis, внешними провайдерами аниме, кэшированием, JWT и хешированием паролей.
...
- Redis вынесен в infrastructure-слой, потому что это технический инструмент для кэша, лимитов и временных security-состояний, а не часть доменной модели.
