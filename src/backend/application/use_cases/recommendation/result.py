...
class RecommendationUseCaseResult:
    ...
    @classmethod
    async def success(cls, data: Any = None, status_code: int = 200) -> RecommendationUseCaseResult:
    ...
    @classmethod
    async def failure(cls, error: str, status_code: int = 400) -> RecommendationUseCaseResult:
