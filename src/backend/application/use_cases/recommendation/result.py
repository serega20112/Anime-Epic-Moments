...
class RecommendationUseCaseResult:
    ...
    @classmethod
    def success(cls, data: Any = None, status_code: int = 200) -> RecommendationUseCaseResult:
    ...
    @classmethod
    def failure(cls, error: str, status_code: int = 400) -> RecommendationUseCaseResult:
