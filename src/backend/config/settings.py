...
class Settings:
    ...
    shikimori_enabled: bool = external.shikimori_enabled()
    shikimori_api_url: str = external.shikimori_api_url()
    shikimori_token: str | None = external.shikimori_token()
    shikimori_user_agent: str = external.shikimori_user_agent()
